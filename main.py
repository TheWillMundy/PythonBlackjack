...
def initial_deal(players, shuffled_deck):
...
def hit_or_stay(players, shuffled_deck, dealer):
    for player in players:
        flag = False
        player_no = player.get_player_no()
...
def end_game(players, shuffled_deck, dealer):
...
def main():
    ...
    while (True):
        ...
        initial_deal(players, shuffled_deck)
        ...
        hit_or_stay(players, shuffled_deck, dealer)
        
        end_game(players, shuffled_deck, dealer)
